...
## v0.7.6 — 2026-04-19 (critical bugs)
- 补齐 3 个缺失 modal handler: paperdoll/skills/achievements (原版就没写过 -> 点了 fall through 显上次内容)
- 角色面板: 职业/等级/章节/HP/攻/暴/连击/boss杀/转生
- 技能树: 4 技能购买+满级标识+金币不足变灰
- 成就: 已完成 ✅ vs 未完成 ⬜ + 金币奖励显示
- 宠物 16→22 像素 + 浮动动画, 猫前排开位置调整

## v0.7.7 — 2026-04-19 (一键合成补回)
...
## v0.7.9 — 2026-04-20 (面向+攻击手感)
- 猫+宠物 scale(-1,1) 水平翻转朝右面对怪物
